 ...
 */
package nl.harmjanwestra.utilities.legacy.genetica.graphics;
...
public class ViolinBoxPlot {
    ...
    public ViolinBoxPlot() {

    }

    boolean plotwilcoxon = true;

    public ViolinBoxPlot(boolean plotWilcoxon) {
        this.plotwilcoxon = plotWilcoxon;
    }
