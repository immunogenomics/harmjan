 ...
 */
package nl.harmjanwestra.utilities.legacy.genetica.methylation;
...
public class CheckMatrixForValidBetaValues {
     ...
     * @return
     */
    public static ArrayList<String> checkMinAndMaxPerSample(nl.harmjanwestra.utilities.legacy.genetica.math.matrix.DoubleMatrixDataset<String, String> dataset, boolean replaceCheckedValuesOutOfRange) {
