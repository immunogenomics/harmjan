...
import nl.harmjanwestra.harmonics.graphics.HistogramPlot;
import nl.harmjanwestra.harmonics.math.NegativeBinomial;
...
public class Tests {
	...
	public static void main(String[] args) {
		...
		try {
			...
			cern.jet.random.NegativeBinomial d = new cern.jet.random.NegativeBinomial(2, 0.3, new DRand());
			...
			NegativeBinomial hjnb = new NegativeBinomial(obs);
