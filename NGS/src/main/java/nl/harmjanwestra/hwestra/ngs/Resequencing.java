 ...
 */
package nl.harmjanwestra.hwestra.ngs;
...
//                }
    ...
    private void determineCoverageForRegions(String regionsBedFile3, String bamfile, String output) throws IOException {
        ...
        System.out.println("Number of features: " + features.size() + " max length: " + maxLen + " min length: " + minLen);
