...
public class LRTest {
    ...
    public LRTest(LRTestOptions options) throws IOException {
        ...
        if (!initialize(options.getAnalysisType())) {
        ...
        switch (options.getAnalysisType()) {
            ...
            case MULTINOMIAL:
                ...
                System.out.println("Will perform multinomial logistic regression");
                break;
            case GUESS:
...
//		ArrayList<String> conditionalVariantIds = new ArrayList<String>();
    ...
    protected boolean initialize(LRTestOptions.ANALYSIS analysismode) throws IOException {
        ...
        if (analysismode.equals(LRTestOptions.ANALYSIS.MULTINOMIAL)) {
            multinomial = true;
        }
