...
public class VCFFilter {
	...
	public void filter(String in, String out, double mafthreshold, int readdepth, int gqual, double callratethreshold) throws IOException {
